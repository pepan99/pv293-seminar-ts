...
export class UpdateUserAdminCommandHandler implements ICommandHandler<UpdateUserAdminCommand> {
    constructor(
    ...
    async execute(command: UpdateUserAdminCommand) {
        ...
        userAggregate.updateRoles(command.updateUserDto.roles as UserRole[], isLastAdmin);
