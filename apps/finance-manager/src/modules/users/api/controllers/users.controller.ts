...
import { ChangePasswordDto, UpdateUserAdminDto, UpdateUserDto } from "../dto/zod-dtos";
...
export class UsersController {
    ...
    async updateProfile(
        ...
        return this.commandBus.execute(new UpdateUserCommand(user.userId, updateUserDto));
    }
    ...
    async changePassword(
        ...
        return this.commandBus.execute(new ChangePasswordCommand(user.userId, changePasswordDto));
    }
    ...
    async update(
        ...
        return this.commandBus.execute(new UpdateUserAdminCommand(id, updateUserDto));
    }
