...
import { RequestUser, UserRole } from "../../../shared-kernel/core/types/user-types";
...
export class UsersController {
    ...
    async getProfile(@User() user: RequestUser): Promise<SelectableUserWithRoles> {
    ...
    async updateProfile(
        ...
        return this.commandBus.execute(
            new UpdateUserCommand(user.userId, updateUserDto.email, updateUserDto.name),
        );
    }
