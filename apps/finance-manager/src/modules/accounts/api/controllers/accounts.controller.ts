...
import { CreateAccountDto, ReconcileAccountDto, UpdateAccountDto } from "../dtos/accounts-zod.dtos";
...
export class AccountsController {
    ...
    async findOne(@Param("id") id: string, @User() user: RequestUser): Promise<SelectableAccounts> {
