...
export class AccountsRepository implements IAccountsRepository {
    ...
    async create(data: InsertableAccounts, userId: string): Promise<SelectableAccounts> {
    ...
    async findOne(id: string, userId: string): Promise<SelectableAccounts | undefined> {
    ...
    async getTotalBalance(userId: string): Promise<number> {
        ...
        return accounts.reduce((total, account) => total + Number(account.initialBalance), 0);
    }
}
