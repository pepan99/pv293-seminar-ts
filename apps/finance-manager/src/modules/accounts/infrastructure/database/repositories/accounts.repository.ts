...
import { CreateAccountDto, UpdateAccountDto } from "../../../api/dtos/accounts-zod.dtos";
...
export class AccountsRepository {
    ...
    async update(id: string, data: UpdateAccountDto, userId: string): Promise<Account | undefined> {
    ...
    async getAccountBalance(id: string, userId: string): Promise<{ balance: number }> {
        const account = await this.findOne(id, userId);
